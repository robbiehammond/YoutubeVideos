...
'''
        ...
        self.play(*[g[i].animate.shift(3 * RIGHT) for i in range(0, len(vertices))])

        rendered_code = Code(code=code, tab_width=4, background="window", font_size=18, language="C++",
                                    font="Monospace")
        rendered_code.move_to(3.5 * LEFT)
        self.play(FadeIn(rendered_code))

        union1 = Tex('union(2, 1)', font_size = 72).shift(3 * DOWN, 2.5 * RIGHT)
        ...
        union2 = Tex('union(3, 4)', font_size = 72).shift(3 * DOWN, 2.5 * RIGHT)
        ...
        find4 = Tex('find(4)', font_size = 72).shift(3 * DOWN, 2.5 * RIGHT)
        ...
        ans = Tex('= 3', font_size=72).shift(3 * DOWN, 3.5 * RIGHT)
        ...
        union3 = Tex('union(2, 4)', font_size = 72).shift(3 * DOWN, 2.5 * RIGHT)
        ...
        union0 = Tex('union(0, 5)', font_size = 72).shift(3 * DOWN, 2.5 * RIGHT)
        ...
        find4Again = Tex('find(4)', font_size = 72).shift(3 * DOWN, 2.5 * RIGHT)
        ...
        self.wait(.5)
        ans2 = Tex('= 2', font_size=72).shift(3 * DOWN, 3.5 * RIGHT)
