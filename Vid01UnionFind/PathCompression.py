...
class PathCompression(Scene):
    def construct(self):    
        ...
        self.play(g[2].animate.set_width(default_width), g[3].animate.set_width(1.2), ReplacementTransform(find3, find3Rep))
        ...
        self.play(g[2].animate.set_width(default_width), g[3].animate.set_width(1.2), ReplacementTransform(find4, find4Rep))
